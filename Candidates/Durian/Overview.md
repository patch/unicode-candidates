...
- **Functional signage:** [Durian signage](<Research/Durian signage.md>) verifies prohibition use in six Southeast Asian territories across transit, accommodation and building rules. The [contributor corpus audit](<Research/Contributor photo corpus synthesis.md>) additionally finds five visibly distinct functional sign designs across seven photographed event groups, with whole, paired, cut-open, filled and outline durian forms. Two pairs are repeat deployments of the same artwork rather than independent designs. This variation is stronger evidence against a one-artwork identity, but the records still establish displayed signs and handling instructions, not transcription, search, indexing, quotation or cross-system exchange of a durian character. The latter is a present absence in the reviewed evidence, not adverse evidence that such interchange does not occur.
...
The five observed functional designs justify a later unlabelled recognition and small monochrome test, but the adverse comparators show why spikes or a stalk alone cannot define the answer in advance. Until the user conception, plain-text operations, concrete losses, design-source independence and recognizable glyph range are tested, the project cannot settle character identity, representative-glyph boundaries or proposal-stage properties.
