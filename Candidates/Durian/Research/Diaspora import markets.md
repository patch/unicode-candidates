---
title: Global reach through diaspora import markets
...
This layer exists to document wider global availability and plausible exposure beyond durian’s core regions in Southeast Asia and Eastern Asia, and to select places where actual symbol comprehension could be studied. Fresh imports show that durian reaches a country. Stable retail, local-language coverage, festivals, packaging, or signs can show repeated local exposure. Only observed graphic use or a recorded recognition study can directly support symbol comprehension.

Accordingly, the market classifications below should be read as a **global-reach screen**, not merely a demographic description and not as proof that a general population recognizes a durian pictogram.
...
Trade value is a screening device, not proof of who ate the fruit or recognized its image. HS 081060 omits frozen whole fruit, pulp, paste, desserts, and most processed products, which can be more accessible to distant diaspora consumers.

## Evidence ladder

| Level | Present evidence | Next evidence needed |
|---|---|---|
| Imported/distributed | HS 081060 value establishes fresh-fruit entry | Add quantities, partners, frozen/prepared forms, and re-exports |
| Repeated local exposure | Demographic geography and occasional retail reporting identify plausible markets | Map stable retailers, packaging, festivals, and local-language media |
| Observed local symbol use | Not established by this import screen | Find non-marketing signs or other functional graphics in the destination country |
| Demonstrated comprehension | Not established | Run recorded unaided/aided recognition tests in defined local populations |

## Priority markets

Local subdivision codes use ISO 3166-2 where applicable; every other namespace is stated explicitly. Codes identify research regions, not the ethnicity of any resident or purchaser.

| Country code | 2023 fresh imports | Market interpretation | Relevant populations | Priority local regions/codes | Evidence strength |
|---|---:|---|---|---|---|
| US | US$9.512m | Mixed specialty market with strong diaspora basis; Hawai‘i also grows a tiny crop | Chinese, Filipino, Vietnamese and broader Southeast Asian populations | California `US-CA`; Texas `US-TX`; New York `US-NY`; Washington `US-WA`; Hawai‘i `US-HI` | High demographic evidence; purchaser link is inferred |
| CA | US$5.269m | Diaspora-oriented/mixed | Chinese, Filipino, Vietnamese | Ontario `CA-ON`; British Columbia `CA-BC`; Alberta `CA-AB`; Manitoba `CA-MB` | High demographic evidence; purchaser link is inferred |
| FR | US$2.468m | Asian-grocery and diaspora-oriented, with some culinary spillover | Vietnamese, Cambodian, Lao and Chinese populations | Île-de-France `FR-IDF`; Paris `FR-75` | Direct Paris retail context plus official national demographics |
| AU | US$1.739m | Mixed: diaspora demand plus niche tropical domestic production | Chinese, Filipino, Vietnamese and Malaysian-born populations | New South Wales `AU-NSW`; Victoria `AU-VIC`; Queensland `AU-QLD`; Western Australia `AU-WA` | High demographic evidence; mixed-market inference |
| IT | US$1.450m | Diaspora-oriented research hypothesis | Chinese and Filipino populations | Lombardy `IT-25`; Tuscany `IT-52`; Lazio `IT-62` | Official community geography; purchaser link untested |
| NO | US$1.204m | Diaspora-oriented research hypothesis | Filipino, Thai, Vietnamese and Chinese populations | Oslo `NO-03` is the first retail-fieldwork priority | Strong national population counts; regional purchaser link untested |
| DE | US$1.150m | Diaspora-oriented/mixed specialty market | Vietnamese and Chinese populations | Berlin `DE-BE`; Saxony `DE-SN` | Strong Berlin Vietnamese evidence; wider purchaser link untested |
| ES | US$1.078m | Diaspora-oriented research hypothesis | Chinese and smaller Southeast Asian populations | Community/retail research priorities: Madrid `ES-MD`, Catalonia `ES-CT`, Valencian Community `ES-VC` | Official census framework; direct durian-buyer evidence weak |
| AE | US$1.039m | Diaspora-oriented/mixed expatriate market | Large Filipino population and other Southeast Asian migrant workers | Dubai `AE-DU`; Abu Dhabi `AE-AZ`; Sharjah `AE-SH` | Strong population context; purchaser link inferred |
...
| Country code | 2023 value | Treatment |
|---|---:|---|
| CN | US$6.721bn | General-population mass market; not diaspora |
| HK | US$404.603m | Territory-wide established market with possible re-exports |
| TW | US$23.504m | General/territory-wide market; UN reporter label “Other Asia, nes” |
| SG | US$15.911m | General-population market |
| MY | US$10.546m | General-population market and producer; imports complement domestic supply |
| MO | US$7.704m | Small territory-wide market; re-export share needs checking |
| BN | US$7.563m | General-population market and producer |
...
- Retrieve reporter–partner flows and net imports before calling any European port a consumer market.
- Add weight, unit value, and frozen/prepared products; fresh value favours air-freighted premium fruit.
- Use census population data only to choose study areas. Interview retailers, wholesalers, and customers before attributing demand to a population.
- Record whether retailers sell Thai, Malaysian, Vietnamese, Philippine, or domestic fruit and whether it is whole, frozen, pulp, or prepared.
- Record local-language product names, packaging imagery, press coverage, festivals, and functional signs as evidence of exposure.
- Test recognition separately among diaspora and non-diaspora residents; do not treat availability or preference as comprehension.
- Identify every local code namespace explicitly, as with the ONS Greater London code, rather than implying that all subdivisions use ISO 3166-2.
