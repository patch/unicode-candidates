...
- **2026-07-22:** Reorganized the result by proposal relevance after review showed that contemporary emoji fruit are materially stronger comparisons than legacy terminal symbols or historical Aegean signs. Adopted one extended grapheme cluster per row, literal display backed by code-point notation and character names, and separate treatment of the represented subject from the mechanism used to encode or sequence it.
