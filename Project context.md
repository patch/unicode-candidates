...
Research whether a durian character has a sound case for encoding, including evidence and reasoning both for and against it, and prepare a proposal if the evidence continues to support that conclusion. The project owner’s present judgement favours encoding, particularly because of durian’s repeated use on signage in Southeast Asia, but the research remains open to disconfirming evidence and better interpretations.
...
Once emoji re-review is confirmed eligible, the intended emoji proposal may cross-reference any public L2 document assigned to the character proposal. The two paths should share evidence without implying that either process guarantees the other outcome. See [[Unicode history and proposal status]].

## Research status

The project owner has already conducted years of research. Contribution and source review are now in progress: the prior Unicode history was reconstructed from its external sources on 22 July 2026 at [[Unicode history and proposal status]]. Other earlier research has not necessarily been contributed or reviewed.
