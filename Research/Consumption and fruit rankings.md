...
“Notable consumption” here means evidence of durian use by the national or territorial public, or by a substantial resident regional population. It is not inferred merely because a country imports fruit or has an Asian supermarket.

### National or territory-wide
...
No common international source was found that gives annual per-person consumption for all fruits, including seasonal durian, across all relevant countries. The following are **five consumption/availability cases plus one imported-fruit proxy, across six countries**. They should never be joined into a cross-country league table.
...
Result: durian ranks **second of eight published selected fruits**. “Selected” matters; this is not guaranteed to be every fruit consumed in Malaysia.
...
| **7** | **Durian** | **1.031** |
| 8 | Avocado | 0.864 |
| 9 | Guava/rose apple | 0.583 |
| 10 | Mango | 0.562 |
| 11 | Duku | 0.306 |

Result: durian ranks **seventh of eleven listed fruits**. The lower per-person mass than Malaysia is compatible with strong cultural salience because durian is seasonal, relatively costly, and not consumed every day.
...
| Rank | Fruit | Respondents selecting |
|---:|---|---:|
| 1 | Orange | 31.66% |
| 2 | Watermelon | 28.14% |
| 3 | Banana | 21.39% |
...
Result: durian ranks **first among the five reported seasonal fruits**. It was not placed into the regular-fruit list, so a combined rank would be methodologically invented.
...
Result: durian ranks **sixth of seven selected fruits** in this constructed view. Because two PSA tables were combined and national figures dilute Mindanao consumption, use this only as a labelled provisional comparison.
...
| 11 | Kiwifruit | 0.027 |
| 12 | Grape | 0.024 |
| 13 | Lime/calamansi | 0.022 |
| 14= | Mango | 0.017 |
| 14= | Strawberry | 0.017 |
| 16 | Pear | 0.014 |
| 17 | Dragon fruit | 0.009 |
| 18 | Mandarin | 0.008 |
| **19=** | **Durian** | **0.006** |
| 19= | Jackfruit | 0.006 |

Result: durian is **tied nineteenth in this mapped fresh-fruit subset**. A one-day recall is particularly liable to understate seasonal foods, so this rank must not be read as a popularity rank.
...
|---:|---|---:|---:|
| **1** | **Fresh durian** | **US$6.72bn** | **1.43m tonnes** |
| 2 | Cherries | US$2.55bn | 334,000 tonnes |
| 3 | Bananas | US$1.08bn | 1.77m tonnes |

Durian ranks first by value, not by physical quantity. Price differences make value an unsuitable substitute for food mass.

## Ranking coverage gaps

The at-large consumption classification contains 16 territories. Five have a durian-inclusive consumption or availability ranking above, and China has an explicitly labelled import proxy. The remaining ten do not have a defensible ranking in this first pass:

| Country code | Current position | Next source to seek |
|---|---|---|
| BN | At-large consumption established; no all-fruit durian-inclusive table found | Department of Economic Planning and Statistics household expenditure or Department of Agriculture food balance |
| HK | Large territory-wide market; no consumption rank found | Census and Statistics Department household expenditure/food-balance microdata |
| MO | At-large classification is provisional from import scale | Statistics and Census Service household expenditure or retail food survey |
| VN | Major producer/consumer; no comparable all-fruit table found | NSO living-standards survey or food balance by commodity |
| TW | Large market and niche production; no comparable consumption table found | Ministry of Agriculture food supply/utilization or household survey |
| KH | Substantial regional/seasonal market | National Institute of Statistics household consumption microdata |
| LA | Substantial regional/seasonal market | Lao Statistics Bureau expenditure/food-consumption microdata |
| LK | Popular seasonal fruit in producing regions | Department of Census and Statistics household expenditure microdata |
| MM | Domestic market and strong producing regions | Central Statistical Organization household expenditure or market-arrival data |
| TZ | Zanzibar regional market | National Bureau of Statistics/Zanzibar household budget data |

These are data gaps, not zeroes. Future work should prefer annual edible mass per person and keep regional results regional.

## Publication guidance

For later publication, state every rank as “rank within [source universe], measured by [metric], [year]”. Avoid “durian is the second most consumed fruit in Malaysia” without the limiting phrase “among the selected fruits in the DOSM Supply and Utilization Accounts”.
